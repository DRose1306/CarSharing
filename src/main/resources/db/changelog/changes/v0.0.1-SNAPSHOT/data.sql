...
VALUES (UUID_TO_BIN('ef6869b7-2402-48c7-bff4-141563be2d8c'), '2020', 'B-B1', 'IN_USE', 'AUDI'),
...
VALUES (UUID_TO_BIN('99b46424-5a60-45a0-b378-cbe9f8a49c73'), '2024-04-20 09:00:00', '2024-04-10 19:00:00', 100.0,
        100.00, UUID_TO_BIN('7270910c-cc71-4634-97a0-a242eb5b6064'),
        UUID_TO_BIN('ef6869b7-2402-48c7-bff4-141563be2d8c')),
       (UUID_TO_BIN('45c423a1-2a2f-4d2e-b5f3-9a844866164d'), '2024-05-10 13:00:00', '2024-05-25 22:30:00', 200.0,
        200.00, UUID_TO_BIN('dfb0689f-5f69-4825-a154-33c897fa1b38'),
        UUID_TO_BIN('3c004a2b-3ff3-4413-8ce3-e72ec557b6fc')),
       (UUID_TO_BIN('530ddcad-d61d-4fc1-9614-3d3f526f3675'), '2024-06-01 00:00:00', '2024-06-20 14:00:00', 300.0,
...
VALUES (UUID_TO_BIN('92683b96-579e-4fee-9329-b442639582e7'), 100.00, '2024-04-10 19:00:00', 'VISA', 1,
        UUID_TO_BIN('7270910c-cc71-4634-97a0-a242eb5b6064')), -- Michael Johnson
       (UUID_TO_BIN('d4379c09-f871-45a1-93b4-a52d9f91ac57'), 200.00, '2024-05-25 22:30:00', 'VISA', 1,
        UUID_TO_BIN('dfb0689f-5f69-4825-a154-33c897fa1b38')), -- Emily Anderson
       (UUID_TO_BIN('ea243166-62d3-4fa1-b168-ae9fd0dc5d6b'), 300.00, '2024-06-20 14:00:00', 'MASTERCARD', 0,
        UUID_TO_BIN('55035fe9-37e3-466f-ba4a-197f23fc5700')), -- Daniel Brown
...
VALUES (UUID_TO_BIN('25203a16-193a-41e8-8a2d-d0ef66738d54'), '2024-04-20 09:00:00', '2024-04-10 19:00:00',
        UUID_TO_BIN('ef6869b7-2402-48c7-bff4-141563be2d8c'), UUID_TO_BIN('7270910c-cc71-4634-97a0-a242eb5b6064')),
       (UUID_TO_BIN('353066d4-36a0-4641-b2bb-3e215fc2b2a5'), '2024-05-10 13:00:00', '2024-05-25 22:30:00',
        UUID_TO_BIN('3c004a2b-3ff3-4413-8ce3-e72ec557b6fc'), UUID_TO_BIN('dfb0689f-5f69-4825-a154-33c897fa1b38')),
       (UUID_TO_BIN('80f84502-bfa1-44d8-938b-0fe7d1fc192d'), '2024-06-01 00:00:00', '2024-06-20 14:00:00',
